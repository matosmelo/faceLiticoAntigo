		...
		<nav class="yellow accent-3 lighten-1" role="navigation">
			<div class="nav-wrapper container">
				...
				<div class="fixed-action-btn vertical click-to-toggle "	style="bottom: 45px; right: 24px;">
					...
					<!-- class="material-icons">format_quote</i></a></li> -->
						<li>
							<a class="btn-floating green" href=""><i class="material-icons">info</i>
							</a>
						</li>
						
						<li>
							<a class="btn-floating blue" href="<c:url value="/pesquisa"/>"><i class="material-icons">search</i>
							</a>
						</li>
					</ul>
				</div>
			...
			<!-- </ul> -->
				...
				<ul id="nav-mobile" class="side-nav">
					<li>
						<a href="<c:url value="/pesquisa"/>">Pesquisa</a>
					</li>
					...
					<!-- <li><a href="html/contato.html">Contato</a></li> -->
					<li>
						<a href="html/sobre.html">Sobre o FACELITICO</a>
					</li>
				</ul>
					...
					<c:forEach items="${liticoList}" var="litico">
						<a class="" href="<c:url value="/${litico.id}"/>">
							<ul class="collection z-depth-1">
								<!-- width="70" height="90" -->
								<li class="collection-item avatar "><img src="resources/imagens/felipe.jpg" alt="" class="circle">
									<span class="title">Nome: ${litico.nome}</span>
									<p> Cargo: ${litico.cargo} </p>
									<p> Partido: ${litico.partido} / ${litico.estado} </p> 
